<?php
/** The input of the user is added to the users table. The input is firstly sanitized to avoid possible attacks.
 * if the username already used the user will get an error message.
 */
session_start();
   ...
   <body>
       ...
       <div class="section">
           ...
           <div class="container">
               ...
               <div class="row">
                    <div class="wrapper">
                       <!--The form that is used to get the data for registering a user. All the fields are required.-->
                            <div class="login">
                              <div class="tabs">
